...
if (!class_exists('Meta_Store_Welcome')) :
    ...
    class Meta_Store_Welcome {
                ...
                <div class="meta-store-welcome-notice-wrap">
                    ...
                    <div class="meta-store-welcome-info">
                        ...
                        <div class="meta-store-welcome-getting-started">
                            ...
                            <p><a href="<?php echo esc_url(admin_url('/themes.php?page=meta-store-welcome')); ?>" class="button button-primary"><?php esc_html_e('Go to Setting Page', 'meta-store'); ?></a></p>
                        </div>
                    </div>
        ...
        public function welcome_register_menu() {
            add_theme_page(esc_html__('Welcome', 'meta-store'), sprintf(esc_html__('%s Settings', 'meta-store'), $this->theme_name), 'edit_theme_options', 'meta-store-welcome', array($this, 'welcome_screen'));
        }
                    ...
                    <div class="welcome-body">
                        <div class="welcome-nav-wrapper">
                            <?php foreach ($tabs as $section_id => $tab) : ?>
                                ...
                                ?>
                                <a href="<?php echo esc_url(admin_url('themes.php?page=meta-store-welcome&section=' . $section_id)); ?>" class="<?php echo esc_attr($nav_class); ?>" >
        ...
        public function welcome_styles_and_scripts($hook) {
            if ('theme-install.php' !== $hook) {
                ...
                wp_enqueue_style('icofont', get_template_directory_uri() . '/vendors/icofont/icofont.css', array(), $this->theme_version);
                wp_enqueue_style('meta-store-welcome', get_template_directory_uri() . '/welcome/css/welcome.css', array(), $this->theme_version);
                wp_enqueue_script('meta-store-welcome', get_template_directory_uri() . '/welcome/js/welcome.js', array('plugin-install', 'updates'), $this->theme_version);

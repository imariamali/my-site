...
class Meta_Store_Background_Image extends WP_Customize_Upload_Control {
    ...
    public function content_template() {
        ...
        <div class="background-image-fields">
            ...
            <# if ( data.attachment && data.overlay ) { #>
            <li class="background-image-overlay">
                <# if ( data.attachment && data.overlay.label ) { #>
                <span class="customize-control-title">{{ data.overlay.label }}</span>
                <# } #>
                <input data-alpha="true" type="text" value="{{ data.overlay.value }}" {{{ data.overlay.link }}} />
            </li>
            <# } #>
        </div>
        ...
        <div class="background-image-color">
            ...
            <# } #>
            <input type="text" value="{{ data.color.value }}" {{{ data.color.link }}} /> 
        </div>
        <# } #>
        <?php
    }

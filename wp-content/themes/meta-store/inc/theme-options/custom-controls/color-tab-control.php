            ...
            <div class="ms-color-tab-contents">
                <div class="ms-color-tab-content-normal" style="display:block">
                    ...
                    <div class="ms-color-content-wrap {{ key }}">
                        ...
                        <input class="ms-alpha-color-control" type="text" value="{{ args.value }}" data-alpha="{{ data.show_opacity }}" data-default-color="{{ args.default }}" data-palette="{{ data.palette }}" {{{ args.link }}} />   
                    </div>
                    <# } ); #>
                </div>
